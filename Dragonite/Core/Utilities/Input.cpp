...
Math::Vector2<float>& CommonUtilities::GClient::GetLeftStick() noexcept
{
	return myLeftStick;
}

Math::Vector2<float>& CommonUtilities::GClient::GetRightStick() noexcept
{
	return myRightStick;
}
...
Math::Vector2<float>& CommonUtilities::GClient::GetDeadzone() noexcept
{
	return myDeadzone;
}
...
Math::Vector2<int> CommonUtilities::Mouse::ourPastMousePosition;


Math::Vector2<float> CommonUtilities::Mouse::ourMouseDelta;
Math::Vector2<int> CommonUtilities::Mouse::ourMousePosition;
...
const Math::Vector2< int> CommonUtilities::Mouse::GetMousePosition()
{
	return ourMousePosition;
}

const Math::Vector2<float> CommonUtilities::Mouse::GetMouseDelta()
{
